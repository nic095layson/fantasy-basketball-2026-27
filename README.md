...
| [report/projections-2026-27.csv](report/projections-2026-27.csv) + [report/rank_engine.py](report/rank_engine.py) | The projections (220 players, 9-cat per-game lines) and the ranking engine that turns them into the board. October workflow: edit CSV rows as news lands, `python3 rank_engine.py`, board regenerates. |
