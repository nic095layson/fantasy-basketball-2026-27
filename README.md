...
| [instructions/claude-ai-project-instructions.md](instructions/claude-ai-project-instructions.md) | Canonical copy of the claude.ai Project instructions (pull-first rule: live repos beat project knowledge; no write-back from claude.ai). Paste block + drift law, same pattern as claude-core-skills. |
