...
def main():
    ...
    lines = [
        ...
        "  Thomas, Jaden Ivey \u2014 were re-verified unsigned 2026-08-18. Harden's",
        "  CLE re-sign is still in talks but unsigned, so he keeps consistent FA",
        "  treatment. Ivey's status rests on a contract tracker plus the absence",
        "  of any reported signing, not on a dated news item; treat it as the",
        "  weakest label on the board.",
