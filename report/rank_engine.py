...
def main():
    ...
    lines = [
        ...
        "  aligned 8/25 with the deck plane's recovered later-8/21 build.) The THREE",
        "  rows still labeled FA \u2014 Kuminga, Cam Thomas, Jaden Ivey \u2014 were",
        "  re-verified unsigned 2026-08-25. Ivey's status rests on a",
