...
def main():
    ...
    lines = [
        ...
        "  camp deal ~8/1) were relabeled to teams in the 2026-08-13 pull. All",
        "  five rows still labeled FA \u2014 James Harden, DeRozan, Kuminga, Cam",
        "  Thomas, Jaden Ivey \u2014 were re-verified unsigned 2026-08-20. Harden's",
        "  stated precondition (Cleveland landing a wing) was SATISFIED by the",
        "  2026-08-19 Peyton Watson trade, and multiple insiders report his deal",
        "  \u2014 around $30M/yr, at most two guaranteed years \u2014 as imminent once",
        "  the five-team trade is processed. He is still unsigned as of this",
        "  build, so he keeps consistent FA treatment; expect him to leave the",
        "  FA block in the next pull. Ivey's status rests on a contract tracker",
        "  plus the absence of any reported signing, not on a dated news item;",
        "  treat it as the weakest label on the board.",
